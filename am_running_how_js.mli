...
(** How the code is currently being run:
...
val am_running_how : t

(** Returns true iff the argument is [`Browser], [`Browser_benchmark], or [`Browser_test]. *)
val am_in_browser : t -> bool

(** Like [am_in_browser], but also returns [true] if [`Node_jsdom_test]. *)
val am_in_browser_like_api : t -> bool
